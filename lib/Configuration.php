...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api.kinow.com/api';
    ...
    {
        $report  = 'PHP SDK (Kinow\Client) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . phpversion() . PHP_EOL;
        $report .= '    OpenAPI Spec Version: 1.4.40' . PHP_EOL;
