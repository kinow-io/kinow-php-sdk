...
class ApiClient
{
     ...
     */
    public function __construct(\Kinow\Client\Configuration $config = null)
    {
        if ($config === null) {
     ...
     *
     * @throws \Kinow\Client\ApiException on a non 2xx response
     * @return mixed
     */
    public function callApi($resourcePath, $method, $queryParams, $postData, $headerParams, $responseType = null, $endpointPath = null)
    {
        ...
        if ($postData and in_array('Content-Type: application/x-www-form-urlencoded', $headers, true)) {
            ...
            $postData = json_encode(\Kinow\Client\ObjectSerializer::sanitizeForSerialization($postData));
        }
        ...
        if ($response_info['http_code'] === 0) {
            ...
            $error_msg = null;
            if (is_object($data) && property_exists($data, 'errors'))  {
                $error_msg = $data->errors;
                $error_msg = is_string($error_msg) ? $error_msg
                                                    : (is_array($error_msg) ? join(" | ", $error_msg)
