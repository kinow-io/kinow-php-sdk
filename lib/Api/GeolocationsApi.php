...
class GeolocationsApi
{
     ...
     * 
     *
     * @param string $type Item type, available values are: category, subscription, product, video, extract, blogpage, slider, topmenu (required)
     * @param int $type_id Item ID (required)
     * @throws \Kaemo\Client\ApiException on non-2xx response
     * @return \Kaemo\Client\Model\GeolocSettings
     */
     ...
     * @param int $type_id Item ID (required)
     * @throws \Kaemo\Client\ApiException on non-2xx response
     * @return array of \Kaemo\Client\Model\GeolocSettings, HTTP status code, HTTP response headers (array of strings)
     */
    public function getGeolocSettingsWithHttpInfo($type, $type_id)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Kaemo\Client\Model\GeolocSettings',
                '/geolocations/settings'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Kaemo\Client\Model\GeolocSettings', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Kaemo\Client\Model\GeolocSettings', $e->getResponseHeaders());
     ...
     * @throws \Kaemo\Client\ApiException on non-2xx response
     * @return \Kaemo\Client\Model\IPLocation
     */
     ...
     * @param string $ip_address address ip (required)
     * @throws \Kaemo\Client\ApiException on non-2xx response
     * @return array of \Kaemo\Client\Model\IPLocation, HTTP status code, HTTP response headers (array of strings)
     */
    public function getIPLocationWithHttpInfo($ip_address)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Kaemo\Client\Model\IPLocation',
                '/geolocations/ip'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Kaemo\Client\Model\IPLocation', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Kaemo\Client\Model\IPLocation', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
     ...
     * @throws \Kaemo\Client\ApiException on non-2xx response
     * @return \Kaemo\Client\Model\PlatformAccessInfo
     */
     ...
     * @param string $ip_address IP address (required)
     * @throws \Kaemo\Client\ApiException on non-2xx response
     * @return array of \Kaemo\Client\Model\PlatformAccessInfo, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPlatformAccessInfoWithHttpInfo($ip_address)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Kaemo\Client\Model\PlatformAccessInfo',
                '/geolocations/platform-access'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Kaemo\Client\Model\PlatformAccessInfo', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Kaemo\Client\Model\PlatformAccessInfo', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
