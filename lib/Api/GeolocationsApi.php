...
class GeolocationsApi
{
     ...
     * @return void
     */
    public function geolocations($ip_address, $page = null, $per_page = null)
    {
        list($response) = $this->geolocationsWithHttpInfo($ip_address, $page, $per_page);
        return $response;
    }
     ...
     */
    public function geolocationsWithHttpInfo($ip_address, $page = null, $per_page = null)
    {
        ...
        // parse inputs
        $resourcePath = "/geolocations/{ip_address}";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
