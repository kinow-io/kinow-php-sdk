...
class AddressApi
{
     ...
     * 
     *
     * @param \Kaemo\Client\Model\Address $body Update address (required)
     * @throws \Kaemo\Client\ApiException on non-2xx response
     * @return \Kaemo\Client\Model\Address
     */
    public function updateAddress($body)
    {
        list($response) = $this->updateAddressWithHttpInfo($body);
        return $response;
    }
     ...
     * @return array of \Kaemo\Client\Model\Address, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateAddressWithHttpInfo($body)
    {
