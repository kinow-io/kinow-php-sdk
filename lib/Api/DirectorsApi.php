...
class DirectorsApi
{
    ...
    /**
     * Operation attachFeaturesToDirector
     *
     * 
     *
     * @param int $director_id  (required)
     * @param string $features To attach existing FeatureValue to director:     &#x60;&#x60;&#x60;     [{     \&quot;id_feature\&quot;:3,     \&quot;id_feature_value\&quot;:5     }]     &#x60;&#x60;&#x60;      To create a custom FeatureValue:     &#x60;&#x60;&#x60;     [{     \&quot;id_feature\&quot;:3,     \&quot;custom_value\&quot;:[{     \&quot;lang\&quot;: 1,     \&quot;value\&quot;: \&quot;string\&quot;     }]     }]     &#x60;&#x60;&#x60; (required)
     * @throws \Kinow\Client\ApiException on non-2xx response
     * @return void
     */
    public function attachFeaturesToDirector($director_id, $features)
    {
        list($response) = $this->attachFeaturesToDirectorWithHttpInfo($director_id, $features);
        return $response;
    }

    /**
     * Operation attachFeaturesToDirectorWithHttpInfo
     *
     * 
     *
     * @param int $director_id  (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function attachFeaturesToDirectorWithHttpInfo($director_id, $features)
    {
        // verify the required parameter 'director_id' is set
        if ($director_id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $director_id when calling attachFeaturesToDirector');
        }
        // verify the required parameter 'features' is set
        if ($features === null) {
            throw new \InvalidArgumentException('Missing the required parameter $features when calling attachFeaturesToDirector');
        }
        // parse inputs
        $resourcePath = "/directors/{director_id}/features";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $headerParams,
                null,
                '/directors/{director_id}/features'
            );
     ...
     */
    public function getDirectorFeatures($director_id, $page = null, $per_page = null)
    {
        list($response) = $this->getDirectorFeaturesWithHttpInfo($director_id, $page, $per_page);
        return $response;
    }

    /**
     * Operation getDirectorFeaturesWithHttpInfo
     *
     * 
     *
     * @param int $director_id Director ID to fetch (required)
     ...
     */
    public function getDirectorFeaturesWithHttpInfo($director_id, $page = null, $per_page = null)
    {
        // verify the required parameter 'director_id' is set
        if ($director_id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $director_id when calling getDirectorFeatures');
        }
        // parse inputs
        $resourcePath = "/directors/{director_id}/features";
        $httpBody = '';
