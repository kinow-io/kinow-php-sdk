...
class DirectorsApi
{
     ...
     * 
     *
     * @param \Kinow\Client\Model\UploadDirectorCoverRequest $body  (required)
     * @throws \Kinow\Client\ApiException on non-2xx response
     * @return \Kinow\Client\Model\Image
     */
    public function uploadDirectorCover($body)
    {
        list($response) = $this->uploadDirectorCoverWithHttpInfo($body);
        return $response;
    }
     ...
     */
    public function uploadDirectorCoverWithHttpInfo($body)
    {
        // verify the required parameter 'body' is set
        if ($body === null) {
            throw new \InvalidArgumentException('Missing the required parameter $body when calling uploadDirectorCover');
        }
        // parse inputs
        $resourcePath = "/directors/{director_id}/cover";
        $httpBody = '';
