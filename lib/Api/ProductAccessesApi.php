...
class ProductAccessesApi
{
     ...
     * @return \Kaemo\Client\Model\ProductAccesses
     */
     ...
     * @param string $date_exp_direction Choose the direction for date_exp parameter, default value is after ,available values are: before, equal, after (optional)
     * @throws \Kaemo\Client\ApiException on non-2xx response
     * @return array of \Kaemo\Client\Model\ProductAccesses, HTTP status code, HTTP response headers (array of strings)
     */
    public function getProductAccessesWithHttpInfo($page = null, $per_page = null, $type = null, $date_add = null, $date_add_direction = null, $date_exp = null, $date_exp_direction = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Kaemo\Client\Model\ProductAccesses',
                '/product-accesses'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Kaemo\Client\Model\ProductAccesses', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Kaemo\Client\Model\ProductAccesses', $e->getResponseHeaders());
