...
class ProductAccessesApi
{
     ...
     * 
     *
     * @param \Kinow\Client\Model\ProductAccess $body  (required)
     * @throws \Kinow\Client\ApiException on non-2xx response
     * @return \Kinow\Client\Model\ProductAccess
     */
     ...
     * @param \Kinow\Client\Model\ProductAccess $body  (required)
     * @throws \Kinow\Client\ApiException on non-2xx response
     * @return array of \Kinow\Client\Model\ProductAccess, HTTP status code, HTTP response headers (array of strings)
     */
    public function createProductAccessWithHttpInfo($body)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Kinow\Client\Model\ProductAccess',
                '/product-accesses'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Kinow\Client\Model\ProductAccess', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 201:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Kinow\Client\Model\ProductAccess', $e->getResponseHeaders());
     ...
     * @return \Kinow\Client\Model\SubscriptionAccesses
     */
    public function getProductAccesses($page = null, $per_page = null, $type = null, $date_add = null, $date_add_direction = null, $date_exp = null, $date_exp_direction = null, $filters = null)
    {
        list($response) = $this->getProductAccessesWithHttpInfo($page, $per_page, $type, $date_add, $date_add_direction, $date_exp, $date_exp_direction, $filters);
        return $response;
    }
     ...
     * @return array of \Kinow\Client\Model\SubscriptionAccesses, HTTP status code, HTTP response headers (array of strings)
     */
    public function getProductAccessesWithHttpInfo($page = null, $per_page = null, $type = null, $date_add = null, $date_add_direction = null, $date_exp = null, $date_exp_direction = null, $filters = null)
    {
        // parse inputs
        $resourcePath = "/product-accesses";
        $httpBody = '';
     ...
     * @return void
     */
    public function unsubscribe($product_access_id)
    {
        list($response) = $this->unsubscribeWithHttpInfo($product_access_id);
        return $response;
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function unsubscribeWithHttpInfo($product_access_id)
    {
        // verify the required parameter 'product_access_id' is set
        if ($product_access_id === null) {
