...
class SupportApi
{
     ...
     * @param bool $send_mail  (optional)
     * @throws \Kaemo\Client\ApiException on non-2xx response
     * @return \Kaemo\Client\Model\Support
     */
    public function createMessage($id_lang, $email, $id_contact, $message, $id_product = null, $id_order = null, $send_mail = null)
    {
        list($response) = $this->createMessageWithHttpInfo($id_lang, $email, $id_contact, $message, $id_product, $id_order, $send_mail);
        return $response;
    }
     ...
     */
    public function createMessageWithHttpInfo($id_lang, $email, $id_contact, $message, $id_product = null, $id_order = null, $send_mail = null)
    {
