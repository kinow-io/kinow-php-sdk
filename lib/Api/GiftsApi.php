...
class GiftsApi
{
     ...
     */
    public function getGifts($unused_only = null, $page = null, $per_page = null)
    {
        list($response) = $this->getGiftsWithHttpInfo($unused_only, $page, $per_page);
        return $response;
    }
     ...
     */
    public function getGiftsWithHttpInfo($unused_only = null, $page = null, $per_page = null)
    {
        // parse inputs
        $resourcePath = "/gifts";
        $httpBody = '';
     ...
     *
     * @param int $gift_id Gift ID to fetch (required)
     * @param \Kinow\Client\Model\Gift3 $body Gift settings (required)
     * @throws \Kinow\Client\ApiException on non-2xx response
     * @return \Kinow\Client\Model\Gift
     */
