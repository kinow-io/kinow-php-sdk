...
class GiftsApi
{
     ...
     * 
     *
     * @param \Kinow\Client\Model\CreateGiftRequest $body Gift settings (required)
     * @throws \Kinow\Client\ApiException on non-2xx response
     * @return \Kinow\Client\Model\GiftResponse
     */
     ...
     * @param \Kinow\Client\Model\CreateGiftRequest $body Gift settings (required)
     * @throws \Kinow\Client\ApiException on non-2xx response
     * @return array of \Kinow\Client\Model\GiftResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createGiftWithHttpInfo($body)
    {
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, '\Kinow\Client\Model\GiftResponse', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 201:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Kinow\Client\Model\GiftResponse', $e->getResponseHeaders());
     ...
     * @param int $gift_id Gift ID to fetch (required)
     * @throws \Kinow\Client\ApiException on non-2xx response
     * @return \Kinow\Client\Model\GiftTokenResponse
     */
     ...
     * @param int $gift_id Gift ID to fetch (required)
     * @throws \Kinow\Client\ApiException on non-2xx response
     * @return array of \Kinow\Client\Model\GiftTokenResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getGiftTokenWithHttpInfo($gift_id)
    {
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, '\Kinow\Client\Model\GiftTokenResponse', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Kinow\Client\Model\GiftTokenResponse', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
     ...
     * @throws \Kinow\Client\ApiException on non-2xx response
     * @return \Kinow\Client\Model\GiftListResponse
     */
     ...
     * @param int $per_page  (optional)
     * @throws \Kinow\Client\ApiException on non-2xx response
     * @return array of \Kinow\Client\Model\GiftListResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getGiftsWithHttpInfo($unused_only = null, $paid_only = null, $page = null, $per_page = null)
    {
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, '\Kinow\Client\Model\GiftListResponse', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Kinow\Client\Model\GiftListResponse', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
     ...
     *
     * @param int $gift_id Gift ID to fetch (required)
     * @param \Kinow\Client\Model\UpdateGiftRequest $body Gift settings (required)
     * @throws \Kinow\Client\ApiException on non-2xx response
     * @return \Kinow\Client\Model\GiftResponse
     */
