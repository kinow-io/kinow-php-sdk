...
class ProductsApi
{
     ...
     * 
     *
     * @param \Kinow\Client\Model\Product $body  (required)
     * @throws \Kinow\Client\ApiException on non-2xx response
     ...
     * @param \Kinow\Client\Model\Product $body  (required)
     * @throws \Kinow\Client\ApiException on non-2xx response
     * @return array of \Kinow\Client\Model\Product, HTTP status code, HTTP response headers (array of strings)
     */
    public function createProductWithHttpInfo($body)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Kinow\Client\Model\Product',
                '/products'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Kinow\Client\Model\Product', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 201:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Kinow\Client\Model\Product', $e->getResponseHeaders());
     ...
     * @param int $per_page  (optional)
     * @throws \Kinow\Client\ApiException on non-2xx response
     * @return \Kinow\Client\Model\ProductAttributesResponse
     */
     ...
     * @param int $per_page  (optional)
     * @throws \Kinow\Client\ApiException on non-2xx response
     * @return array of \Kinow\Client\Model\ProductAttributesResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getProductAttributesWithHttpInfo($product_id, $page = null, $per_page = null)
    {
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, '\Kinow\Client\Model\ProductAttributesResponse', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Kinow\Client\Model\ProductAttributesResponse', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
     ...
     * @param int $product_id Product ID to fetch (required)
     * @throws \Kinow\Client\ApiException on non-2xx response
     * @return \Kinow\Client\Model\Subscription
     */
     ...
     * @param int $product_id Product ID to fetch (required)
     * @throws \Kinow\Client\ApiException on non-2xx response
     * @return array of \Kinow\Client\Model\Subscription, HTTP status code, HTTP response headers (array of strings)
     */
    public function getProductSubscriptionWithHttpInfo($product_id)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Kinow\Client\Model\Subscription',
                '/products/{product_id}/subscription'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Kinow\Client\Model\Subscription', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Kinow\Client\Model\Subscription', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
     ...
     * @param int $page  (optional)
     * @param int $per_page  (optional)
     * @param string $features &#x60;&#x60;&#x60;     featureId[value]&#x3D;string&amp;featureId[operator]&#x3D;strict     _______________      {     \&quot;*\&quot;: {     \&quot;value\&quot;: \&quot;string\&quot;,     \&quot;operator\&quot;: \&quot;strict\&quot;     },     \&quot;1\&quot;: {     \&quot;value\&quot;: \&quot;string\&quot;,     \&quot;operator\&quot;: \&quot;contains\&quot;     }     } &#x60;&#x60;&#x60;     Operator can be: strict, contains, between, in, gt (greater than), lt (lower than).     To search on all features, you can pass * as featureId. (optional)
     * @param string $filters &#x60;&#x60;&#x60;     name[value]&#x3D;string&amp;name[operator]&#x3D;contains&amp;date_add[value]&#x3D;string&amp;date_add[operator]&#x3D;lt     _______________      {     \&quot;name\&quot;: {     \&quot;value\&quot;: \&quot;string\&quot;,     \&quot;operator\&quot;: \&quot;contains\&quot;     },     \&quot;date_add\&quot;: {     \&quot;value\&quot;: \&quot;string\&quot;,     \&quot;operator\&quot;: \&quot;lt\&quot;     }     } &#x60;&#x60;&#x60;     Operator can be: strict, contains, between, in, gt (greater than), lt (lower than). (optional)
     * @param string $sort_by Sort by this attribute (id by default) (optional)
     * @param string $sort_direction Sorting direction (asc by default) (optional)
     * @param string $ip Filter by user IP (optional)
     ...
     * @return \Kinow\Client\Model\Products
     */
    public function getProducts($page = null, $per_page = null, $features = null, $filters = null, $sort_by = null, $sort_direction = null, $ip = null, $customer_id = null)
    {
        list($response) = $this->getProductsWithHttpInfo($page, $per_page, $features, $filters, $sort_by, $sort_direction, $ip, $customer_id);
        return $response;
    }
     ...
     * @return array of \Kinow\Client\Model\Products, HTTP status code, HTTP response headers (array of strings)
     */
    public function getProductsWithHttpInfo($page = null, $per_page = null, $features = null, $filters = null, $sort_by = null, $sort_direction = null, $ip = null, $customer_id = null)
    {
        // parse inputs
        $resourcePath = "/products";
        $httpBody = '';
     ...
     * @param string $ip Filter by user IP (optional)
     * @param string $sort_by Sort by this attribute (default is ID) (optional)
     * @param string $sort_direction Sorting direction (asc by default) (optional)
     * @throws \Kinow\Client\ApiException on non-2xx response
     * @return \Kinow\Client\Model\Videos2
     */
    public function getVideosFromProduct($product_id, $page = null, $per_page = null, $filters = null, $ip = null, $sort_by = null, $sort_direction = null)
    {
        list($response) = $this->getVideosFromProductWithHttpInfo($product_id, $page, $per_page, $filters, $ip, $sort_by, $sort_direction);
        return $response;
    }
     ...
     * @param string $sort_direction Sorting direction (asc by default) (optional)
     * @throws \Kinow\Client\ApiException on non-2xx response
     * @return array of \Kinow\Client\Model\Videos2, HTTP status code, HTTP response headers (array of strings)
     */
    public function getVideosFromProductWithHttpInfo($product_id, $page = null, $per_page = null, $filters = null, $ip = null, $sort_by = null, $sort_direction = null)
    {
        // verify the required parameter 'product_id' is set
        if ($product_id === null) {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Kinow\Client\Model\Videos2',
                '/products/{product_id}/videos'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Kinow\Client\Model\Videos2', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Kinow\Client\Model\Videos2', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
