...
class ProductsApi
{
     ...
     */
    public function getCustomerHasAccessToProducts($customer_id, $body, $ip_address = null)
    {
        list($response) = $this->getCustomerHasAccessToProductsWithHttpInfo($customer_id, $body, $ip_address);
        return $response;
    }
     ...
     */
    public function getCustomerHasAccessToProductsWithHttpInfo($customer_id, $body, $ip_address = null)
    {
        // verify the required parameter 'customer_id' is set
        if ($customer_id === null) {
