...
class ProductsApi
{
     ...
     * @throws \Kinow\Client\ApiException on non-2xx response
     * @return \Kinow\Client\Model\CartPriceResponse[]
     */
     ...
     * @param \Kinow\Client\Model\ProductIDList1 $body List of Product IDs separated by comma, eg. &#39;42,21,84&#39; (required)
     * @throws \Kinow\Client\ApiException on non-2xx response
     * @return array of \Kinow\Client\Model\CartPriceResponse[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getPriceWithHttpInfo($body)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Kinow\Client\Model\CartPriceResponse[]',
                '/products/price'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Kinow\Client\Model\CartPriceResponse[]', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Kinow\Client\Model\CartPriceResponse[]', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
     ...
     * 
     *
     * @param \Kinow\Client\Model\UploadProductCoverRequest $body  (required)
     * @throws \Kinow\Client\ApiException on non-2xx response
     * @return \Kinow\Client\Model\ImageResponse
     */
    public function uploadProductCover($body)
    {
        list($response) = $this->uploadProductCoverWithHttpInfo($body);
        return $response;
    }
     ...
     * @return array of \Kinow\Client\Model\ImageResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function uploadProductCoverWithHttpInfo($body)
    {
        // verify the required parameter 'body' is set
        if ($body === null) {
            throw new \InvalidArgumentException('Missing the required parameter $body when calling uploadProductCover');
        }
        // parse inputs
        $resourcePath = "/products/{product_id}/cover";
        $httpBody = '';
     ...
     * @return \Kinow\Client\Model\Image
     */
    public function uploadProductImage($product_id, $file, $hash, $image_type_name, $hash_algorithm = null)
    {
        list($response) = $this->uploadProductImageWithHttpInfo($product_id, $file, $hash, $image_type_name, $hash_algorithm);
        return $response;
    }
     ...
     * @return array of \Kinow\Client\Model\Image, HTTP status code, HTTP response headers (array of strings)
     */
    public function uploadProductImageWithHttpInfo($product_id, $file, $hash, $image_type_name, $hash_algorithm = null)
    {
        // verify the required parameter 'product_id' is set
        if ($product_id === null) {
        ...
        if ($file === null) {
            throw new \InvalidArgumentException('Missing the required parameter $file when calling uploadProductImage');
        }
        // verify the required parameter 'hash' is set
        if ($hash === null) {
            throw new \InvalidArgumentException('Missing the required parameter $hash when calling uploadProductImage');
        }
