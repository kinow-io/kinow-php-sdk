...
class ProductsApi
{
     ...
     *
     * @param int $customer_id Customer ID to fetch (required)
     * @param \Kaemo\Client\Model\ProductIDList $body List of Product IDs separated by comma, eg. &#39;42,21,84&#39; (required)
     * @throws \Kaemo\Client\ApiException on non-2xx response
     * @return \Kaemo\Client\Model\ProductAccessInfo[]
     */
     ...
     * @param \Kaemo\Client\Model\ProductIDList $body List of Product IDs separated by comma, eg. &#39;42,21,84&#39; (required)
     * @throws \Kaemo\Client\ApiException on non-2xx response
     * @return array of \Kaemo\Client\Model\ProductAccessInfo[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getCustomerHasAccessToProductsWithHttpInfo($customer_id, $body)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Kaemo\Client\Model\ProductAccessInfo[]',
                '/customers/{customer_id}/products/has-access'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Kaemo\Client\Model\ProductAccessInfo[]', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Kaemo\Client\Model\ProductAccessInfo[]', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
