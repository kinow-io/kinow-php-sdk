...
class ProductsApi
{
     ...
     * @param string $image_type  (optional)
     * @throws \Kinow\Client\ApiException on non-2xx response
     * @return \Kinow\Client\Model\Directors
     */
     ...
     * @param string $image_type  (optional)
     * @throws \Kinow\Client\ApiException on non-2xx response
     * @return array of \Kinow\Client\Model\Directors, HTTP status code, HTTP response headers (array of strings)
     */
    public function getProductDirectorsWithHttpInfo($product_id, $page = null, $per_page = null, $image_type = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Kinow\Client\Model\Directors',
                '/products/{product_id}/directors'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Kinow\Client\Model\Directors', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Kinow\Client\Model\Directors', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
