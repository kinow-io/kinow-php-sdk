...
class ProductsApi
{
     ...
     */
    public function getCustomerHasAccessToProducts($customer_id, $ip_address, $body)
    {
        list($response) = $this->getCustomerHasAccessToProductsWithHttpInfo($customer_id, $ip_address, $body);
        return $response;
    }
     ...
     */
    public function getCustomerHasAccessToProductsWithHttpInfo($customer_id, $ip_address, $body)
    {
        // verify the required parameter 'customer_id' is set
        if ($customer_id === null) {
        ...
        if ($ip_address === null) {
            throw new \InvalidArgumentException('Missing the required parameter $ip_address when calling getCustomerHasAccessToProducts');
        }
        // verify the required parameter 'body' is set
        if ($body === null) {
