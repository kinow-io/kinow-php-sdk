...
class ProductsApi
{
     ...
     * @return void
     */
    public function getProductAvailability($product_id, $customer_id = null)
    {
        list($response) = $this->getProductAvailabilityWithHttpInfo($product_id, $customer_id);
        return $response;
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function getProductAvailabilityWithHttpInfo($product_id, $customer_id = null)
    {
        // verify the required parameter 'product_id' is set
        if ($product_id === null) {
