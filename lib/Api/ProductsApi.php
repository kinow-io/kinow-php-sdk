...
class ProductsApi
{
    ...
    /**
     * Operation attachProductToDirector_0
     *
     * 
     *
     * @param int $product_id ID of the product (required)
     ...
     * @return void
     */
    public function attachProductToDirector_0($product_id, $group_id)
    {
        list($response) = $this->attachProductToDirector_0WithHttpInfo($product_id, $group_id);
        return $response;
    }

    /**
     * Operation attachProductToDirector_0WithHttpInfo
     *
     * 
     *
     * @param int $product_id ID of the product (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function attachProductToDirector_0WithHttpInfo($product_id, $group_id)
    {
        // verify the required parameter 'product_id' is set
        if ($product_id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $product_id when calling attachProductToDirector_0');
        }
        // verify the required parameter 'group_id' is set
        if ($group_id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $group_id when calling attachProductToDirector_0');
        }
        // parse inputs
