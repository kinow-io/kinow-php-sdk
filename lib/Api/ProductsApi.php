...
class ProductsApi
{
     ...
     */
    public function getCategoryProducts($category_id, $page = null, $per_page = null, $sort_by = null, $sort_direction = null, $ip = null)
    {
        list($response) = $this->getCategoryProductsWithHttpInfo($category_id, $page, $per_page, $sort_by, $sort_direction, $ip);
        return $response;
    }
     ...
     */
    public function getCategoryProductsWithHttpInfo($category_id, $page = null, $per_page = null, $sort_by = null, $sort_direction = null, $ip = null)
    {
        // verify the required parameter 'category_id' is set
        if ($category_id === null) {
