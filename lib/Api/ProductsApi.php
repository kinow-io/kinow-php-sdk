...
class ProductsApi
{
     ...
     * @return \Kaemo\Client\Model\Products
     */
    public function searchProducts($search_query, $page = null, $per_page = null)
    {
        list($response) = $this->searchProductsWithHttpInfo($search_query, $page, $per_page);
        return $response;
    }
     ...
     * @return array of \Kaemo\Client\Model\Products, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchProductsWithHttpInfo($search_query, $page = null, $per_page = null)
    {
