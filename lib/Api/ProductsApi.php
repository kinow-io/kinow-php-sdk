...
class ProductsApi
{
    ...
    /**
     * Operation detachProductFromActor
     *
     * 
     *
     * @param int $product_id Product ID to fetch (required)
     ...
     * @return void
     */
    public function detachProductFromActor($product_id, $actor_id)
    {
        list($response) = $this->detachProductFromActorWithHttpInfo($product_id, $actor_id);
        return $response;
    }

    /**
     * Operation detachProductFromActorWithHttpInfo
     *
     * 
     *
     * @param int $product_id Product ID to fetch (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function detachProductFromActorWithHttpInfo($product_id, $actor_id)
    {
        // verify the required parameter 'product_id' is set
        if ($product_id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $product_id when calling detachProductFromActor');
        }
        // verify the required parameter 'actor_id' is set
        if ($actor_id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $actor_id when calling detachProductFromActor');
        }
        // parse inputs
