...
class CustomersApi
{
     ...
     * @param bool $force_client_api_refresh Return Client API refresh token (optional)
     * @param bool $force_client_api_access Return Client API access token (optional)
     * @throws \Kinow\Client\ApiException on non-2xx response
     * @return string
     */
    public function generateAuthenticationToken($customer_id, $force_client_api_refresh = null, $force_client_api_access = null)
    {
        list($response) = $this->generateAuthenticationTokenWithHttpInfo($customer_id, $force_client_api_refresh, $force_client_api_access);
        return $response;
    }
     ...
     */
    public function generateAuthenticationTokenWithHttpInfo($customer_id, $force_client_api_refresh = null, $force_client_api_access = null)
    {
        // verify the required parameter 'customer_id' is set
        if ($customer_id === null) {
        ...
        // query params
        if ($force_client_api_refresh !== null) {
            $queryParams['force_client_api_refresh'] = $this->apiClient->getSerializer()->toQueryValue($force_client_api_refresh);
        }
        // query params
        if ($force_client_api_access !== null) {
            $queryParams['force_client_api_access'] = $this->apiClient->getSerializer()->toQueryValue($force_client_api_access);
        }
        // path params
        if ($customer_id !== null) {
            $resourcePath = str_replace(
