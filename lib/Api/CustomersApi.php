...
class CustomersApi
{
     ...
     * 
     *
     * @param \Kinow\Client\Model\CustomerCreateRequest $body Created user object (required)
     * @throws \Kinow\Client\ApiException on non-2xx response
     * @return \Kinow\Client\Model\Customer
     */
     ...
     */
    public function passwordToken($email)
    {
        list($response) = $this->passwordTokenWithHttpInfo($email);
        return $response;
    }
     ...
     */
    public function passwordTokenWithHttpInfo($email)
    {
        // verify the required parameter 'email' is set
        if ($email === null) {
