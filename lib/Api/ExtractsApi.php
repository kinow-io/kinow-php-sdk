...
class ExtractsApi
{
     ...
     * 
     *
     * @param \Kinow\Client\Model\CreateExtractRequest $body  (required)
     * @throws \Kinow\Client\ApiException on non-2xx response
     * @return \Kinow\Client\Model\ExtractResponse
     */
     ...
     * @param \Kinow\Client\Model\CreateExtractRequest $body  (required)
     * @throws \Kinow\Client\ApiException on non-2xx response
     * @return array of \Kinow\Client\Model\ExtractResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createExtractWithHttpInfo($body)
    {
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, '\Kinow\Client\Model\ExtractResponse', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 201:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Kinow\Client\Model\ExtractResponse', $e->getResponseHeaders());
     ...
     */
    public function getExtractPlayer($extract_id, $customer_id = null, $ip_address = null, $iso_code = null)
    {
        list($response) = $this->getExtractPlayerWithHttpInfo($extract_id, $customer_id, $ip_address, $iso_code);
        return $response;
    }
     ...
     */
    public function getExtractPlayerWithHttpInfo($extract_id, $customer_id = null, $ip_address = null, $iso_code = null)
    {
        // verify the required parameter 'extract_id' is set
        if ($extract_id === null) {
     ...
     *
     * @param int $extract_id Extract ID to fetch (required)
     * @param \Kinow\Client\Model\UpdateExtractRequest $body  (required)
     * @throws \Kinow\Client\ApiException on non-2xx response
     * @return \Kinow\Client\Model\ExtractResponse
     */
