...
class ExtractsApi
{
     ...
     */
    public function getExtracts($page = null, $per_page = null)
    {
        list($response) = $this->getExtractsWithHttpInfo($page, $per_page);
        return $response;
    }
     ...
     */
    public function getExtractsWithHttpInfo($page = null, $per_page = null)
    {
        // parse inputs
        $resourcePath = "/extracts";
        $httpBody = '';
