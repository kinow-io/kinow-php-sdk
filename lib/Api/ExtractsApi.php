...
class ExtractsApi
{
     ...
     */
    public function getExtractPlayer($extract_id, $ip_address = null, $iso_code = null)
    {
        list($response) = $this->getExtractPlayerWithHttpInfo($extract_id, $ip_address, $iso_code);
        return $response;
    }
     ...
     */
    public function getExtractPlayerWithHttpInfo($extract_id, $ip_address = null, $iso_code = null)
    {
        // verify the required parameter 'extract_id' is set
        if ($extract_id === null) {
