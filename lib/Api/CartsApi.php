...
class CartsApi
{
     ...
     */
    public function addProductToCart($cart_id, $product_id, $ip_address, $product_attribute_id = null, $switch_subscription_id = null, $is_gift = null)
    {
        list($response) = $this->addProductToCartWithHttpInfo($cart_id, $product_id, $ip_address, $product_attribute_id, $switch_subscription_id, $is_gift);
        return $response;
    }
     ...
     */
    public function addProductToCartWithHttpInfo($cart_id, $product_id, $ip_address, $product_attribute_id = null, $switch_subscription_id = null, $is_gift = null)
    {
        ...
        if ($ip_address === null) {
            throw new \InvalidArgumentException('Missing the required parameter $ip_address when calling addProductToCart');
        }
        // parse inputs
        ...
        // form params
        if ($is_gift !== null) {
            $formParams['is_gift'] = $this->apiClient->getSerializer()->toFormValue($is_gift);
        }
     ...
     * 
     *
     * @param \Kaemo\Client\Model\Cart1 $body Cart settings (required)
     * @throws \Kaemo\Client\ApiException on non-2xx response
     * @return \Kaemo\Client\Model\Cart
     */
     ...
     * @param \Kaemo\Client\Model\Cart2 $body Cart settings (required)
     * @throws \Kaemo\Client\ApiException on non-2xx response
     * @return \Kaemo\Client\Model\Cart
     */
