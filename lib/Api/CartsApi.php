...
class CartsApi
{
     ...
     */
    public function addProductToCart($cart_id, $product_id, $product_attribute_id = null)
    {
        list($response) = $this->addProductToCartWithHttpInfo($cart_id, $product_id, $product_attribute_id);
        return $response;
    }
     ...
     */
    public function addProductToCartWithHttpInfo($cart_id, $product_id, $product_attribute_id = null)
    {
