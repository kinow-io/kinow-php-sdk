...
class ImagesApi
{
     ...
     * 
     *
     * @param \Kinow\Client\Model\UploadSubscriptionCoverRequest $body  (required)
     * @throws \Kinow\Client\ApiException on non-2xx response
     * @return \Kinow\Client\Model\ImageResponse
     */
    public function uploadSubscriptionCover($body)
    {
        list($response) = $this->uploadSubscriptionCoverWithHttpInfo($body);
        return $response;
    }
     ...
     * @return array of \Kinow\Client\Model\ImageResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function uploadSubscriptionCoverWithHttpInfo($body)
    {
        // verify the required parameter 'body' is set
        if ($body === null) {
            throw new \InvalidArgumentException('Missing the required parameter $body when calling uploadSubscriptionCover');
        }
        // parse inputs
        $resourcePath = "/subscriptions/{subscription_id}/cover";
        $httpBody = '';
