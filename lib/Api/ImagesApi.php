...
class ImagesApi
{
    ...
    /**
     * Operation deleteProductScreenshot
     *
     * 
     *
     ...
     * @return void
     */
    public function deleteProductScreenshot($product_id, $image_id)
    {
        list($response) = $this->deleteProductScreenshotWithHttpInfo($product_id, $image_id);
        return $response;
    }

    /**
     * Operation deleteProductScreenshotWithHttpInfo
     *
     * 
     *
     * @param float $product_id Product ID to fetch (required)
     ...
     */
    public function deleteProductScreenshotWithHttpInfo($product_id, $image_id)
    {
        // verify the required parameter 'product_id' is set
        if ($product_id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $product_id when calling deleteProductScreenshot');
        }
        // verify the required parameter 'image_id' is set
        if ($image_id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $image_id when calling deleteProductScreenshot');
        }
        // parse inputs
    ...
    /**
     * Operation getCategoryThumbnail
     *
     * 
     *
     * @param int $category_id Category ID to fetch (required)
     ...
     * @return \Kaemo\Client\Model\Image
     */
    public function getCategoryThumbnail($category_id)
    {
        list($response) = $this->getCategoryThumbnailWithHttpInfo($category_id);
        return $response;
    }

    /**
     * Operation getCategoryThumbnailWithHttpInfo
     *
     * 
     *
     * @param int $category_id Category ID to fetch (required)
     ...
     * @return array of \Kaemo\Client\Model\Image, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCategoryThumbnailWithHttpInfo($category_id)
    {
        // verify the required parameter 'category_id' is set
        if ($category_id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $category_id when calling getCategoryThumbnail');
        }
        // parse inputs
        $resourcePath = "/categories/{category_id}/thumbnail";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $headerParams,
                '\Kaemo\Client\Model\Image',
                '/categories/{category_id}/thumbnail'
            );
