...
class BlogPagesApi
{
     ...
     * @param int $blog_page_id Page ID to fetch (required)
     * @throws \Kinow\Client\ApiException on non-2xx response
     * @return \Kinow\Client\Model\BlogPage
     */
     ...
     * @param int $blog_page_id Page ID to fetch (required)
     * @throws \Kinow\Client\ApiException on non-2xx response
     * @return array of \Kinow\Client\Model\BlogPage, HTTP status code, HTTP response headers (array of strings)
     */
    public function getBlogPageWithHttpInfo($blog_page_id)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Kinow\Client\Model\BlogPage',
                '/blog-pages/{blog_page_id}'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Kinow\Client\Model\BlogPage', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Kinow\Client\Model\BlogPage', $e->getResponseHeaders());
     ...
     */
    public function getBlogPageProducts($blog_page_id, $page = null, $per_page = null)
    {
        list($response) = $this->getBlogPageProductsWithHttpInfo($blog_page_id, $page, $per_page);
        return $response;
    }
     ...
     */
    public function getBlogPageProductsWithHttpInfo($blog_page_id, $page = null, $per_page = null)
    {
        // verify the required parameter 'blog_page_id' is set
        if ($blog_page_id === null) {
     ...
     * @throws \Kinow\Client\ApiException on non-2xx response
     * @return \Kinow\Client\Model\BlogPageLists
     */
     ...
     * @param string $sort_direction Sorting direction (asc by default) (optional)
     * @throws \Kinow\Client\ApiException on non-2xx response
     * @return array of \Kinow\Client\Model\BlogPageLists, HTTP status code, HTTP response headers (array of strings)
     */
    public function getBlogPagesWithHttpInfo($page = null, $per_page = null, $filters = null, $sort_by = null, $sort_direction = null)
    {
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, '\Kinow\Client\Model\BlogPageLists', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Kinow\Client\Model\BlogPageLists', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
