...
class StatsApi
{
     ...
     * @return \Kaemo\Client\Model\CustomerVideoStat
     */
     ...
     * @param int $per_page  (optional)
     * @throws \Kaemo\Client\ApiException on non-2xx response
     * @return array of \Kaemo\Client\Model\CustomerVideoStat, HTTP status code, HTTP response headers (array of strings)
     */
    public function getVideoStatsByCustomersWithHttpInfo($customer_id = null, $date_from = null, $date_to = null, $page = null, $per_page = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Kaemo\Client\Model\CustomerVideoStat',
                '/video-stats/customers'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Kaemo\Client\Model\CustomerVideoStat', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Kaemo\Client\Model\CustomerVideoStat', $e->getResponseHeaders());
     ...
     * @param int $page  (optional)
     * @throws \Kaemo\Client\ApiException on non-2xx response
     * @return \Kaemo\Client\Model\VideoStat
     */
    public function getVideoStatsByVideo($customer_id = null, $date_from = null, $date_to = null, $page = null)
    {
        list($response) = $this->getVideoStatsByVideoWithHttpInfo($customer_id, $date_from, $date_to, $page);
        return $response;
    }
     ...
     * @param int $page  (optional)
     * @throws \Kaemo\Client\ApiException on non-2xx response
     * @return array of \Kaemo\Client\Model\VideoStat, HTTP status code, HTTP response headers (array of strings)
     */
    public function getVideoStatsByVideoWithHttpInfo($customer_id = null, $date_from = null, $date_to = null, $page = null)
    {
        // parse inputs
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Kaemo\Client\Model\VideoStat',
                '/video-stats/videos'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Kaemo\Client\Model\VideoStat', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Kaemo\Client\Model\VideoStat', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
     ...
     * @param int $per_page  (optional)
     * @throws \Kaemo\Client\ApiException on non-2xx response
     * @return \Kaemo\Client\Model\SessionVideoStat
     */
     ...
     * @param int $per_page  (optional)
     * @throws \Kaemo\Client\ApiException on non-2xx response
     * @return array of \Kaemo\Client\Model\SessionVideoStat, HTTP status code, HTTP response headers (array of strings)
     */
    public function getVideoStatsSessionsWithHttpInfo($customer_id = null, $video_id = null, $date_from = null, $date_to = null, $page = null, $per_page = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Kaemo\Client\Model\SessionVideoStat',
                '/video-stats/sessions'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Kaemo\Client\Model\SessionVideoStat', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Kaemo\Client\Model\SessionVideoStat', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
