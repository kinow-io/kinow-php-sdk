...
class StatsApi
{
     ...
     * @throws \Kinow\Client\ApiException on non-2xx response
     * @return \Kinow\Client\Model\SessionVideoStatResponse[]
     */
     ...
     * @param \Kinow\Client\Model\VideoIDList1 $body List of Video IDs separated by comma, eg. &#39;42,21,84&#39; (required)
     * @throws \Kinow\Client\ApiException on non-2xx response
     * @return array of \Kinow\Client\Model\SessionVideoStatResponse[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getCustomerSessionsMultipleWithHttpInfo($customer_id, $body)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Kinow\Client\Model\SessionVideoStatResponse[]',
                '/video-stats/{customer_id}/sessions'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Kinow\Client\Model\SessionVideoStatResponse[]', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Kinow\Client\Model\SessionVideoStatResponse[]', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
