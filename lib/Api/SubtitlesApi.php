...
class SubtitlesApi
{
     ...
     * @return \Kaemo\Client\Model\SubtitleFiles
     */
     ...
     * @param int $per_page  (optional)
     * @throws \Kaemo\Client\ApiException on non-2xx response
     * @return array of \Kaemo\Client\Model\SubtitleFiles, HTTP status code, HTTP response headers (array of strings)
     */
    public function getSubtitlesWithHttpInfo($page = null, $per_page = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Kaemo\Client\Model\SubtitleFiles',
                '/subtitles'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Kaemo\Client\Model\SubtitleFiles', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Kaemo\Client\Model\SubtitleFiles', $e->getResponseHeaders());
