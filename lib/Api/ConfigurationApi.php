...
class ConfigurationApi
{
     ...
     * @param int $per_page  (optional)
     * @throws \Kinow\Client\ApiException on non-2xx response
     * @return \Kinow\Client\Model\Analytics
     */
     ...
     * @param int $per_page  (optional)
     * @throws \Kinow\Client\ApiException on non-2xx response
     * @return array of \Kinow\Client\Model\Analytics, HTTP status code, HTTP response headers (array of strings)
     */
    public function getConfigurationAnalyticsWithHttpInfo($page = null, $per_page = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Kinow\Client\Model\Analytics',
                '/configuration/analytics'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Kinow\Client\Model\Analytics', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Kinow\Client\Model\Analytics', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
