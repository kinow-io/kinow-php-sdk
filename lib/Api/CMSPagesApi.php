...
class CMSPagesApi
{
     ...
     * 
     *
     * @param \Kinow\Client\Model\CreateCMSPageRequest $body  (required)
     * @throws \Kinow\Client\ApiException on non-2xx response
     * @return \Kinow\Client\Model\CMSPageResponse
     */
     ...
     * @param \Kinow\Client\Model\CreateCMSPageRequest $body  (required)
     * @throws \Kinow\Client\ApiException on non-2xx response
     * @return array of \Kinow\Client\Model\CMSPageResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createCMSPageWithHttpInfo($body)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Kinow\Client\Model\CMSPageResponse',
                '/cms-pages'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Kinow\Client\Model\CMSPageResponse', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 201:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Kinow\Client\Model\CMSPageResponse', $e->getResponseHeaders());
     ...
     * @throws \Kinow\Client\ApiException on non-2xx response
     * @return \Kinow\Client\Model\CMSPageListResponse
     */
     ...
     * @param string $sort_direction Sorting direction (asc by default) (optional)
     * @throws \Kinow\Client\ApiException on non-2xx response
     * @return array of \Kinow\Client\Model\CMSPageListResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCMSPagesWithHttpInfo($page = null, $per_page = null, $filters = null, $sort_by = null, $sort_direction = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Kinow\Client\Model\CMSPageListResponse',
                '/cms-pages'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Kinow\Client\Model\CMSPageListResponse', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Kinow\Client\Model\CMSPageListResponse', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
     ...
     * @param \Kinow\Client\Model\UpdateCMSPageRequest $body  (required)
     * @throws \Kinow\Client\ApiException on non-2xx response
     * @return \Kinow\Client\Model\CMSPageResponse
     */
