...
class VideosApi
{
     ...
     */
    public function getVideos($page = null, $per_page = null)
    {
        list($response) = $this->getVideosWithHttpInfo($page, $per_page);
        return $response;
    }
     ...
     */
    public function getVideosWithHttpInfo($page = null, $per_page = null)
    {
        // parse inputs
        $resourcePath = "/videos";
        $httpBody = '';
