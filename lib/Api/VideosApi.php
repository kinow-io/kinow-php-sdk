...
class VideosApi
{
     ...
     */
    public function getVideos($page = null, $per_page = null, $features = null, $filters = null)
    {
        list($response) = $this->getVideosWithHttpInfo($page, $per_page, $features, $filters);
        return $response;
    }
     ...
     */
    public function getVideosWithHttpInfo($page = null, $per_page = null, $features = null, $filters = null)
    {
        // parse inputs
        $resourcePath = "/videos";
        $httpBody = '';
