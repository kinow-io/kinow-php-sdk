...
class VideosApi
{
     ...
     * @param string $ip_address IP address (optional)
     * @param string $force_reload Force seekbar to the begining and ignore viewing resume (optional)
     * @throws \Kinow\Client\ApiException on non-2xx response
     * @return \Kinow\Client\Model\PlayerConfiguration
     */
    public function getVideoPlayer($video_id, $customer_id = null, $country_id = null, $ip_address = null, $force_reload = null)
    {
        list($response) = $this->getVideoPlayerWithHttpInfo($video_id, $customer_id, $country_id, $ip_address, $force_reload);
        return $response;
    }
     ...
     */
    public function getVideoPlayerWithHttpInfo($video_id, $customer_id = null, $country_id = null, $ip_address = null, $force_reload = null)
    {
        // verify the required parameter 'video_id' is set
        if ($video_id === null) {
