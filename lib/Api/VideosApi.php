...
class VideosApi
{
     ...
     */
    public function getVideoPlayerUrl($video_id)
    {
        list($response) = $this->getVideoPlayerUrlWithHttpInfo($video_id);
        return $response;
    }
     ...
     */
    public function getVideoPlayerUrlWithHttpInfo($video_id)
    {
        // verify the required parameter 'video_id' is set
        if ($video_id === null) {
