...
class VideosApi
{
     ...
     */
    public function getPlayerIframe($video_id, $customer_id = null)
    {
        list($response) = $this->getPlayerIframeWithHttpInfo($video_id, $customer_id);
        return $response;
    }

    /**
     * Operation getPlayerIframeWithHttpInfo
     *
     * 
     *
     * @param int $video_id Id of the video to fetch (required)
     ...
     */
    public function getPlayerIframeWithHttpInfo($video_id, $customer_id = null)
    {
        // verify the required parameter 'video_id' is set
        if ($video_id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $video_id when calling getPlayerIframe');
        }
        // parse inputs
        $resourcePath = "/videos/{video_id}/player-iframe";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
