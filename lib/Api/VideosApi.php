...
class VideosApi
{
     ...
     */
    public function getCustomerHasAccessToVideos($customer_id, $body, $ip_address = null)
    {
        list($response) = $this->getCustomerHasAccessToVideosWithHttpInfo($customer_id, $body, $ip_address);
        return $response;
    }
     ...
     */
    public function getCustomerHasAccessToVideosWithHttpInfo($customer_id, $body, $ip_address = null)
    {
        // verify the required parameter 'customer_id' is set
        if ($customer_id === null) {
