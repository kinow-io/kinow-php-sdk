...
class VideosApi
{
     ...
     * @param \Kaemo\Client\Model\CreateVideoSubtitleRequest $body Subtitle settings (required)
     * @throws \Kaemo\Client\ApiException on non-2xx response
     * @return \Kaemo\Client\Model\Subtitle
     */
    public function createSubtitle($video_id, $body)
    {
        list($response) = $this->createSubtitleWithHttpInfo($video_id, $body);
        return $response;
    }
     ...
     */
    public function createSubtitleWithHttpInfo($video_id, $body)
    {
        // verify the required parameter 'video_id' is set
        if ($video_id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $video_id when calling createSubtitle');
        }
     ...
     *
     * @param int $customer_id Customer ID to fetch (required)
     * @param \Kaemo\Client\Model\VideoIDList1 $body List of Video IDs separated by comma, eg. &#39;42,21,84&#39; (required)
     * @throws \Kaemo\Client\ApiException on non-2xx response
     ...
     * @throws \Kaemo\Client\ApiException on non-2xx response
     * @return \Kaemo\Client\Model\DownloadInformations
     */
     ...
     * @param string $ip_address IP address (optional)
     * @throws \Kaemo\Client\ApiException on non-2xx response
     * @return array of \Kaemo\Client\Model\DownloadInformations, HTTP status code, HTTP response headers (array of strings)
     */
    public function getVideoDownloadUrlWithHttpInfo($video_id, $customer_id = null, $ip_address = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Kaemo\Client\Model\DownloadInformations',
                '/videos/{video_id}/download-url'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Kaemo\Client\Model\DownloadInformations', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Kaemo\Client\Model\DownloadInformations', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
     ...
     * @param string $ip_address IP address (optional)
     * @throws \Kaemo\Client\ApiException on non-2xx response
     * @return \Kaemo\Client\Model\Player1
     */
    public function getVideoPlayer($video_id, $customer_id = null, $country_id = null, $ip_address = null)
    {
        list($response) = $this->getVideoPlayerWithHttpInfo($video_id, $customer_id, $country_id, $ip_address);
        return $response;
    }
     ...
     * @param string $ip_address IP address (optional)
     * @throws \Kaemo\Client\ApiException on non-2xx response
     * @return array of \Kaemo\Client\Model\Player1, HTTP status code, HTTP response headers (array of strings)
     */
    public function getVideoPlayerWithHttpInfo($video_id, $customer_id = null, $country_id = null, $ip_address = null)
    {
        // verify the required parameter 'video_id' is set
        if ($video_id === null) {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Kaemo\Client\Model\Player1',
                '/videos/{video_id}/player'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Kaemo\Client\Model\Player1', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Kaemo\Client\Model\Player1', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
