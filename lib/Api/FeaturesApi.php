...
class FeaturesApi
{
    ...
    /**
     * Operation attachFeaturesToBlogPage
     *
     * 
     *
     * @param int $blog_page_id  (required)
     * @param string $features To attach existing FeatureValue to blog page:     &#x60;&#x60;&#x60;     [{     \&quot;id_feature\&quot;:3,     \&quot;id_feature_value\&quot;:5     }]     &#x60;&#x60;&#x60;      To create a custom FeatureValue:     &#x60;&#x60;&#x60;     [{     \&quot;id_feature\&quot;:3,     \&quot;custom_value\&quot;:[{     \&quot;lang\&quot;: 1,     \&quot;value\&quot;: \&quot;string\&quot;     }]     }]     &#x60;&#x60;&#x60; (required)
     * @throws \Kinow\Client\ApiException on non-2xx response
     * @return void
     */
    public function attachFeaturesToBlogPage($blog_page_id, $features)
    {
        list($response) = $this->attachFeaturesToBlogPageWithHttpInfo($blog_page_id, $features);
        return $response;
    }

    /**
     * Operation attachFeaturesToBlogPageWithHttpInfo
     *
     * 
     *
     * @param int $blog_page_id  (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function attachFeaturesToBlogPageWithHttpInfo($blog_page_id, $features)
    {
        // verify the required parameter 'blog_page_id' is set
        if ($blog_page_id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $blog_page_id when calling attachFeaturesToBlogPage');
        }
        // verify the required parameter 'features' is set
        if ($features === null) {
            throw new \InvalidArgumentException('Missing the required parameter $features when calling attachFeaturesToBlogPage');
        }
        // parse inputs
        $resourcePath = "/blog-pages/{blog_page_id}/features";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $headerParams,
                null,
                '/blog-pages/{blog_page_id}/features'
            );
     ...
     * @return \Kinow\Client\Model\FeatureListResponse
     */
    public function getBlogPageFeatures($blog_page_id, $page = null, $per_page = null)
    {
        list($response) = $this->getBlogPageFeaturesWithHttpInfo($blog_page_id, $page, $per_page);
        return $response;
    }

    /**
     * Operation getBlogPageFeaturesWithHttpInfo
     *
     * 
     *
     * @param int $blog_page_id Blog page ID to fetch (required)
     ...
     * @return array of \Kinow\Client\Model\FeatureListResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getBlogPageFeaturesWithHttpInfo($blog_page_id, $page = null, $per_page = null)
    {
        // verify the required parameter 'blog_page_id' is set
        if ($blog_page_id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $blog_page_id when calling getBlogPageFeatures');
        }
        // parse inputs
        $resourcePath = "/blog-pages/{blog_page_id}/features";
        $httpBody = '';
     ...
     * @param int $per_page  (optional)
     * @throws \Kinow\Client\ApiException on non-2xx response
     * @return \Kinow\Client\Model\FeatureValueListResponse1
     */
     ...
     * @param int $per_page  (optional)
     * @throws \Kinow\Client\ApiException on non-2xx response
     * @return array of \Kinow\Client\Model\FeatureValueListResponse1, HTTP status code, HTTP response headers (array of strings)
     */
    public function getFeatureValuesWithHttpInfo($page = null, $per_page = null)
    {
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, '\Kinow\Client\Model\FeatureValueListResponse1', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Kinow\Client\Model\FeatureValueListResponse1', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
