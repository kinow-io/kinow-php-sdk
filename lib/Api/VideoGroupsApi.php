...
class VideoGroupsApi
{
     ...
     * @return \Kinow\Client\Model\VideoGroupResponse
     */
     ...
     * @param int $video_group_id Video group ID to fetch (required)
     * @throws \Kinow\Client\ApiException on non-2xx response
     * @return array of \Kinow\Client\Model\VideoGroupResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getVideoGroupWithHttpInfo($video_group_id)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Kinow\Client\Model\VideoGroupResponse',
                '/video-groups/{video_group_id}'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Kinow\Client\Model\VideoGroupResponse', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Kinow\Client\Model\VideoGroupResponse', $e->getResponseHeaders());
