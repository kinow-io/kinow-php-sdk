...
class CustomerThreadsApi
{
     ...
     * @throws \Kaemo\Client\ApiException on non-2xx response
     * @return \Kaemo\Client\Model\CustomerThreadList
     */
     ...
     * @param string $date_add_operator  (optional)
     * @throws \Kaemo\Client\ApiException on non-2xx response
     * @return array of \Kaemo\Client\Model\CustomerThreadList, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCustomerThreadsWithHttpInfo($page = null, $per_page = null, $date_add = null, $date_add_operator = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Kaemo\Client\Model\CustomerThreadList',
                '/customer-threads'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Kaemo\Client\Model\CustomerThreadList', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Kaemo\Client\Model\CustomerThreadList', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
