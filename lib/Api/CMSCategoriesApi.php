...
class CMSCategoriesApi
{
     ...
     * 
     *
     * @param \Kinow\Client\Model\CMSCategory $body  (required)
     * @throws \Kinow\Client\ApiException on non-2xx response
     * @return \Kinow\Client\Model\CMSCategory
     */
     ...
     * @param \Kinow\Client\Model\CMSCategory $body  (required)
     * @throws \Kinow\Client\ApiException on non-2xx response
     * @return array of \Kinow\Client\Model\CMSCategory, HTTP status code, HTTP response headers (array of strings)
     */
    public function createCMSCategoryWithHttpInfo($body)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Kinow\Client\Model\CMSCategory',
                '/cms-categories'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Kinow\Client\Model\CMSCategory', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 201:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Kinow\Client\Model\CMSCategory', $e->getResponseHeaders());
     ...
     * @throws \Kinow\Client\ApiException on non-2xx response
     * @return \Kinow\Client\Model\CMSCategoriesLists
     */
     ...
     * @param string $sort_direction Sorting direction (asc by default) (optional)
     * @throws \Kinow\Client\ApiException on non-2xx response
     * @return array of \Kinow\Client\Model\CMSCategoriesLists, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCMSCategoriesWithHttpInfo($page = null, $per_page = null, $filters = null, $sort_by = null, $sort_direction = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Kinow\Client\Model\CMSCategoriesLists',
                '/cms-categories'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Kinow\Client\Model\CMSCategoriesLists', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Kinow\Client\Model\CMSCategoriesLists', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
