...
class FreeGiftsApi
{
     ...
     * 
     *
     * @param \Kinow\Client\Model\CreateFreeGiftRequest $body Free Gift settings (required)
     * @throws \Kinow\Client\ApiException on non-2xx response
     ...
     * @param int $free_gift_id Free Gift ID to fetch (required)
     * @throws \Kinow\Client\ApiException on non-2xx response
     * @return \Kinow\Client\Model\FreeGiftResponse
     */
     ...
     * @param int $free_gift_id Free Gift ID to fetch (required)
     * @throws \Kinow\Client\ApiException on non-2xx response
     * @return array of \Kinow\Client\Model\FreeGiftResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getFreeGiftWithHttpInfo($free_gift_id)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Kinow\Client\Model\FreeGiftResponse',
                '/free-gifts/{free_gift_id}'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Kinow\Client\Model\FreeGiftResponse', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Kinow\Client\Model\FreeGiftResponse', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
     ...
     * @throws \Kinow\Client\ApiException on non-2xx response
     * @return \Kinow\Client\Model\FreeGiftListResponse
     */
     ...
     * @param int $unused_only Only unused Gifts (optional)
     * @throws \Kinow\Client\ApiException on non-2xx response
     * @return array of \Kinow\Client\Model\FreeGiftListResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getFreeGiftsWithHttpInfo($unused_only = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Kinow\Client\Model\FreeGiftListResponse',
                '/free-gifts'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Kinow\Client\Model\FreeGiftListResponse', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Kinow\Client\Model\FreeGiftListResponse', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
