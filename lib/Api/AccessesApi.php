...
class AccessesApi
{
     ...
     * @return \Kaemo\Client\Model\Categories1
     */
    public function getAvailableCategories($customer_id = null)
    {
        list($response) = $this->getAvailableCategoriesWithHttpInfo($customer_id);
        return $response;
    }
     ...
     * @param int $customer_id ID of the customer to fetch (optional)
     * @throws \Kaemo\Client\ApiException on non-2xx response
     * @return array of \Kaemo\Client\Model\Categories1, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAvailableCategoriesWithHttpInfo($customer_id = null)
    {
        // parse inputs
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Kaemo\Client\Model\Categories1',
                '/categories-accesses'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Kaemo\Client\Model\Categories1', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Kaemo\Client\Model\Categories1', $e->getResponseHeaders());
