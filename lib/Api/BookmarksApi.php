...
class BookmarksApi
{
     ...
     * @param int $playlist_id  (optional)
     * @throws \Kinow\Client\ApiException on non-2xx response
     * @return void
     */
    public function attachBookmarkToCustomer($customer_id, $product_id, $playlist_id = null)
    {
        list($response) = $this->attachBookmarkToCustomerWithHttpInfo($customer_id, $product_id, $playlist_id);
        return $response;
    }
     ...
     */
    public function attachBookmarkToCustomerWithHttpInfo($customer_id, $product_id, $playlist_id = null)
    {
        ...
        // form params
        if ($playlist_id !== null) {
            $formParams['playlist_id'] = $this->apiClient->getSerializer()->toFormValue($playlist_id);
        }
     ...
     * @return void
     */
    public function detachBookmarkFromCustomer($customer_id, $product_id, $playlist_id = null)
    {
        list($response) = $this->detachBookmarkFromCustomerWithHttpInfo($customer_id, $product_id, $playlist_id);
        return $response;
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function detachBookmarkFromCustomerWithHttpInfo($customer_id, $product_id, $playlist_id = null)
    {
        // verify the required parameter 'customer_id' is set
        if ($customer_id === null) {
     ...
     */
    public function getCustomerBookmarks($customer_id, $playlist_id = null, $page = null, $per_page = null, $sort_by = null, $sort_direction = null)
    {
        list($response) = $this->getCustomerBookmarksWithHttpInfo($customer_id, $playlist_id, $page, $per_page, $sort_by, $sort_direction);
        return $response;
    }
     ...
     */
    public function getCustomerBookmarksWithHttpInfo($customer_id, $playlist_id = null, $page = null, $per_page = null, $sort_by = null, $sort_direction = null)
    {
        // verify the required parameter 'customer_id' is set
        if ($customer_id === null) {
        ...
        // query params
        if ($playlist_id !== null) {
            $queryParams['playlist_id'] = $this->apiClient->getSerializer()->toQueryValue($playlist_id);
        }
        // query params
        if ($page !== null) {
