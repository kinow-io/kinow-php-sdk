...
class CategoriesApi
{
     ...
     */
    public function getCategories($page = null, $per_page = null, $features = null)
    {
        list($response) = $this->getCategoriesWithHttpInfo($page, $per_page, $features);
        return $response;
    }
     ...
     */
    public function getCategoriesWithHttpInfo($page = null, $per_page = null, $features = null)
    {
        // parse inputs
