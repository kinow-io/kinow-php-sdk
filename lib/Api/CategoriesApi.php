...
class CategoriesApi
{
     ...
     */
    public function getCategoryPlayer($video_id, $customer_id = null, $country_id = null, $iso_code = null)
    {
        list($response) = $this->getCategoryPlayerWithHttpInfo($video_id, $customer_id, $country_id, $iso_code);
        return $response;
    }

    /**
     * Operation getCategoryPlayerWithHttpInfo
     *
     * 
     *
     * @param int $video_id Video ID to fetch (required)
     ...
     */
    public function getCategoryPlayerWithHttpInfo($video_id, $customer_id = null, $country_id = null, $iso_code = null)
    {
        // verify the required parameter 'video_id' is set
        if ($video_id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $video_id when calling getCategoryPlayer');
        }
        // parse inputs
