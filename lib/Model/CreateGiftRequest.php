...
/**
 * CreateGiftRequest Class Doc Comment
 *
 * @category    Class */
/**
 * @package     Kinow\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class CreateGiftRequest implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CreateGiftRequest';
    ...
    /**
     * Sets auto_link
     * @param bool $auto_link Auto-link Gift to an existing Product in Cart with same IDs - true by default
     * @return $this
     */
