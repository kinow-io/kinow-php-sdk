 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class FreeGift1 implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'FreeGift_1';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['id_product_attribute'] === null) {
            $invalid_properties[] = "'id_product_attribute' can't be null";
        }
     ...
     * @param int $id_product_attribute Product ID attribute to offer
     * @return $this
     */
    ...
    /**
     * Sets id_customer
     * @param int $id_customer Sender Customer ID
     * @return $this
     */
