...
## **createCMSCategory**
> \Kinow\Client\Model\CMSCategoryResponse createCMSCategory($body)
...
$body = new \Kinow\Client\Model\CreateCMSCategoryRequest(); // \Kinow\Client\Model\CreateCMSCategoryRequest | 
...
------------- | ------------- | ------------- | -------------
 **body** | [**\Kinow\Client\Model\CreateCMSCategoryRequest**](#\Kinow\Client\Model\CreateCMSCategoryRequest)|  |

### Return type

[**\Kinow\Client\Model\CMSCategoryResponse**](#CMSCategoryResponse)
...
## **updateCMSCategory**
> \Kinow\Client\Model\CMSCategoryResponse updateCMSCategory($cms_category_id, $body)
...
$body = new \Kinow\Client\Model\UpdateCMSCategoryRequest(); // \Kinow\Client\Model\UpdateCMSCategoryRequest | 
 ...
 **body** | [**\Kinow\Client\Model\UpdateCMSCategoryRequest**](#\Kinow\Client\Model\UpdateCMSCategoryRequest)|  |
